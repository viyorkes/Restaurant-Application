...
public class OpenAiService {
    ...
    /**
     * Creates a new ChatGptConfig.OpenAiService that wraps ChatGptConfig.OpenAiApi
     *
     ...
     * Creates a new ChatGptConfig.OpenAiService that wraps ChatGptConfig.OpenAiApi
     *
     * @param api ChatGptConfig.OpenAiApi instance to use for all methods
     */
